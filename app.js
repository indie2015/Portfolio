    ...
    mydeck.forEach(function(card) {
      ...
      card.addEventListener('click',function(e) {
       ...
       setTimeout(function() {
         ...
         let numofStars = document.querySelectorAll('ul.stars li');
         ...
         if(numofStars.length > 2 && numofmoves >= 41) {
             stars.removeChild(starchild);
         }
         if(numofStars.length == 2 && numofmoves >= 51) {
...
function initGame() {
  ...
  //Add the number of stars back if needed
  if(numofStars.length < 3) {

    //Create the list element
    let mylistitem = document.createElement('li');

    //Create the icon item and add classes
    let myiconitem = document.createElement('i');
    myiconitem.classList.add('fa','fa-star');

    //Add the icon to the list item
    mylistitem.appendChild(myiconitem);

    //Add the list item to the unordered listener
    stars.appendChild(mylistitem);
  }
